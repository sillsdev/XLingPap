...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:psmi="http://www.CraneSoftwrights.com/resources/psmi" xmlns:saxon="http://icl.com/saxon">
    ...
    <xsl:template match="/lingPaper">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format"
            ...
            <xsl:comment> generated by XLingPapFO1.xsl Version <xsl:value-of select="$sVersion"
                />&#x20;</xsl:comment>
            <!-- Page layouts -->
            <fo:layout-master-set>
                ...
                <xsl:if test="$landscapes">
                    <xsl:element name="fo:simple-page-master" use-attribute-sets="EvenPageLayout">
                        <xsl:attribute name="master-name"
                            >FrontMatterTOCLandscapeEvenPage</xsl:attribute>
                        <fo:region-body margin-top="{$sHeaderMargin}"
                            margin-bottom="{$sFooterMargin}" reference-orientation="90">
                            <xsl:call-template name="DoDebugFrontMatterBody"/>
                        </fo:region-body>
                        <fo:region-before region-name="FrontMatterTOCEvenPage-before"
                            extent="{$sHeaderMargin}">
                    ...
                    <xsl:element name="fo:simple-page-master" use-attribute-sets="OddPageLayout">
                        <xsl:attribute name="master-name"
                            >FrontMatterTOCLandscapeOddPage</xsl:attribute>
                        <fo:region-body margin-top="{$sHeaderMargin}"
                            margin-bottom="{$sFooterMargin}" reference-orientation="90">
                            <xsl:call-template name="DoDebugFrontMatterBody"/>
                        </fo:region-body>
                ...
                <xsl:if test="$landscapes">
                    <xsl:element name="fo:simple-page-master" use-attribute-sets="EvenPageLayout">
                        ...
                        <fo:region-before region-name="ChapterEvenPage-before"
                            extent="{$sHeaderMargin}">
                            <xsl:call-template name="DoDebugHeader"/>
                        </fo:region-before>
                        <fo:region-after region-name="xsl-region-after" extent="{$sFooterMargin}">
                    ...
                    <xsl:element name="fo:simple-page-master" use-attribute-sets="OddPageLayout">
                        ...
                        <fo:region-before region-name="ChapterOddPage-before"
                            extent="{$sHeaderMargin}">
                            <xsl:call-template name="DoDebugHeader"/>
                        </fo:region-before>
                        <fo:region-after region-name="xsl-region-after" extent="{$sFooterMargin}">
                ...
                <xsl:if test="$chapters">
                    <fo:page-sequence-master master-name="FrontMatter">
                        <fo:repeatable-page-master-alternatives>
                            ...
                            <fo:conditional-page-master-reference odd-or-even="even"
                                ...
                                master-reference="FrontMatterBlankEvenPage"/>
                        </fo:repeatable-page-master-alternatives>
                    ...
                    <xsl:if test="$landscapes">
                        <fo:page-sequence-master master-name="FrontMatterTOCLandscape">
                            <fo:repeatable-page-master-alternatives>
                                <fo:conditional-page-master-reference odd-or-even="even"
                                    master-reference="FrontMatterTOCLandscapeEvenPage"/>
                                <fo:conditional-page-master-reference odd-or-even="odd"
                                    master-reference="FrontMatterTOCLandscapeOddPage"/>
                            </fo:repeatable-page-master-alternatives>
                        </fo:page-sequence-master>
                    </xsl:if>
                ...
                <xsl:if test="$landscapes">
                    <fo:page-sequence-master master-name="ChapterLandscape">
                        <fo:repeatable-page-master-alternatives>
                            <fo:conditional-page-master-reference odd-or-even="even"
                                master-reference="ChapterLandscapeEvenPage"/>
                            <fo:conditional-page-master-reference odd-or-even="odd"
                                master-reference="ChapterLandscapeOddPage"/>
                        </fo:repeatable-page-master-alternatives>
                    </fo:page-sequence-master>
    ...
    <xsl:template match="frontMatter">
        <xsl:choose>
            <xsl:when test="$chapters and not(ancestor::chapterInCollection)">
                <fo:page-sequence master-reference="FrontMatter" format="i">
                    ...
                    <fo:flow flow-name="xsl-region-body">
                        ...
                        <xsl:apply-templates
                            select="title | subtitle | author | affiliation | emailAddress | presentedAt | date | version | ../publishingInfo/publishingBlurb"
                        />
                    </fo:flow>
                </fo:page-sequence>
            ...
            <xsl:when test="ancestor::chapterInCollection">
                <xsl:apply-templates
                    select="author | affiliation | emailAddress | presentedAt | date | version | ../publishingInfo/publishingBlurb | contents"/>
                ...
                <fo:page-sequence master-reference="Chapter">
                    <xsl:attribute name="initial-page-number">
                        <xsl:choose>
                            <xsl:when
                                ...
                                >1</xsl:when>
                            <xsl:when
                                test="name()='chapterInCollection' and not(parent::part) and position()=1 or preceding-sibling::*[1][name(.)='frontMatter']"
                                >1</xsl:when>
                            <xsl:otherwise>
                    ...
                    <fo:flow flow-name="xsl-region-body">
                        ...
                        <xsl:apply-templates
                            select="title | subtitle | author | affiliation | emailAddress | presentedAt | date | version | ../publishingInfo/publishingBlurb"/>
                        <xsl:apply-templates
                            select="contents | acknowledgements | abstract | preface" mode="paper"/>
    ...
    <xsl:template match="title[not(ancestor::chapterInCollection)]">
        <xsl:if test="$chapters">
            <fo:block font-size="18pt" font-weight="bold" text-align="center" space-before="1.25in"
        ...
        <fo:block font-size="18pt" font-weight="bold" text-align="center" space-before="1.25in"
            space-before.conditionality="retain" break-before="odd-page">
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template match="subtitle">
        <fo:block font-size="14pt" font-weight="bold" text-align="center" space-before=".25in"
            space-before.conditionality="retain">
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template match="contents" mode="book">
        <fo:page-sequence master-reference="FrontMatterTOC" initial-page-number="auto-odd"
            format="i">
        ...
        <xsl:variable name="sId">
            <xsl:call-template name="GetIdToUse">
                <xsl:with-param name="sBaseId"
                    select="concat($sPrefaceID,'.',count(preceding-sibling::preface)+1)"/>
            </xsl:call-template>
        </xsl:variable>
        <xsl:call-template name="OutputTOCLine">
            <xsl:with-param name="sLink" select="$sId"/>
    ...
    <xsl:template match="part">
        <fo:page-sequence master-reference="Chapter">
            <xsl:attribute name="initial-page-number">
                <xsl:choose>
                    <xsl:when
                        test="name()='chapter' and position()=1 or preceding-sibling::*[1][name(.)='frontMatter']"
                        >1</xsl:when>
                    <xsl:when
                        test="name()='chapterInCollection' and position()=1 or preceding-sibling::*[1][name(.)='frontMatter']"
                        >1</xsl:when>
            ...
            <fo:flow flow-name="xsl-region-body">
                ...
                <fo:block id="{@id}" font-size="18pt" font-weight="bold" break-before="page"
                    margin-top="144pt" margin-bottom="10.8pt" text-align="center">
    ...
    <xsl:template match="section1">
        <fo:block id="{@id}" font-weight="bold" text-align="center"
    ...
    <xsl:template match="section2">
        <fo:block id="{@id}" font-weight="bold" text-align="left"
            keep-with-next.within-page="always">
            <xsl:attribute name="font-size">
    ...
    <xsl:template match="section3">
        <fo:block id="{@id}" font-weight="bold" font-style="italic" text-align="left"
            keep-with-next.within-page="always">
            <xsl:attribute name="font-size">
    ...
    <xsl:template match="section4 | section5 | section6">
        <fo:block id="{@id}" font-style="italic" text-align="left"
            keep-with-next.within-page="always">
            <xsl:attribute name="font-size">
    ...
    <xsl:template match="endnote">
        ...
        <fo:footnote>
            <xsl:variable name="iTablenumberedAdjust">
                <xsl:choose>
                    <xsl:when
                        test="ancestor::tablenumbered and $lingPaper/@tablenumberedLabelAndCaptionLocation='after'">
                        <xsl:choose>
                        ...
                        <fo:block text-align="left" text-indent="1em">
                            ...
                            <xsl:choose>
                                <xsl:when test="$chapters">
                                    ...
                                    <xsl:for-each
                                        select="$chapters[descendant::endnote[@id=$sNoteId]]">
                                        <xsl:number level="any"
                                            count="chapter | chapterInCollection" format="1"/>
                                    </xsl:for-each>
                                    <xsl:text>.</xsl:text>
                                </xsl:when>
                                <xsl:otherwise>
                ...
                <fo:table-body>
                    <fo:table-row>
                        <xsl:call-template name="DoContactInfo">
                            <xsl:with-param name="authorInfo"
                                select="key('AuthorContactID',@author)"/>
                        </xsl:call-template>
...
-->
    ...
    <xsl:template match="landscape">
        ...
        <psmi:page-sequence master-reference="{$sMasterMainName}Landscape"
                                ...
                                <xsl:when test="$myClosestSection">
                                    <xsl:choose>
                                        <xsl:when test="$myClosestSection/shortTitle">
                                            <xsl:apply-templates
                                                select="$myClosestSection/shortTitle"/>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:apply-templates
                                                select="$myClosestSection/secTitle/child::node()[name()!='endnote']"
                                            />
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </xsl:when>
...
-->
    <xsl:template mode="number" match="*">
      ...
      -->
        <xsl:choose>
            <xsl:when
                test="count($chapters)=0 and count(//section1)=1 and count(//section1/section2)=0">
            ...
            <xsl:otherwise>
                <xsl:number level="multiple"
                    count="section1 | section2 | section3 | section4 | section5 | section6"
                    format="1.1"/>
            </xsl:otherwise>
        </xsl:choose>
...
-->
    <xsl:template mode="endnote" match="endnote[parent::author]">
        <xsl:variable name="iAuthorPosition"
            select="count(ancestor::author/preceding-sibling::author[endnote]) + 1"/>
        ...
        <xsl:choose>
            <xsl:when test="$chapters">
                <xsl:number level="any"
                    ...
                    from="chapter | appendix | chapterInCollection | glossary | acknowledgements | preface | abstract"
                    format="1"/>
    ...
    <xsl:template mode="figure" match="*" priority="10">
        <xsl:choose>
            <xsl:when test="$chapters">
                <xsl:for-each
                    select="ancestor::chapter | ancestor::appendix | ancestor::chapterBeforePart | ancestor::chapterInCollection">
                    <xsl:call-template name="OutputChapterNumber">
                ...
                <xsl:number level="any" count="figure"
                    from="chapter | appendix | chapterBeforePart | chapterInCollection" format="1"/>
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template mode="tablenumbered" match="*" priority="10">
        <xsl:choose>
            <xsl:when test="$chapters">
                ...
                <xsl:text>.</xsl:text>
                <xsl:number level="any" count="tablenumbered"
                    from="chapter | appendix | chapterBeforePart | chapterInCollection" format="1"/>
            </xsl:when>
            <xsl:otherwise>
...
-->
    <xsl:template mode="letter" match="*">
        <xsl:number level="single"
            count="listWord | listSingle | listInterlinear | listDefinition | lineSet" format="a"/>
    </xsl:template>
    <!--  
                  dateLetter
-->
   ...
   -->
    ...
    <xsl:template name="DoContents">
        ...
        <xsl:if test="//part">
            <xsl:for-each select="//part">
                ...
                <fo:block text-align="center" space-before="{$sBasicPointSize - 4}pt"
                    space-after="{$sBasicPointSize}pt" keep-with-next.within-page="2">
    ...
    <xsl:template name="DoContentsInChapterInCollection">
        ...
        <xsl:for-each select="ancestor::chapterInCollection">
            <xsl:apply-templates
                select="frontMatter/abstract | frontMatter/acknowledgements | frontMatter/preface"
                mode="contents"/>
            <xsl:call-template name="OutputAllSectionTOC">
                <xsl:with-param name="nLevel">
                    <xsl:value-of select="$nLevel"/>
    ...
    <xsl:template name="DoRefWork">
        ...
        <fo:block text-indent="-.25in" start-indent=".25in">
            ...
            <xsl:if test="../@showAuthorName!='no'">
                ...
                <xsl:if test="substring($author,string-length($author),string-length($author))!='.'"
                    >.</xsl:if>
                <xsl:text>&#x20;  </xsl:text>
            ...
            <xsl:if test="collection">
                ...
                <xsl:choose>
                    <xsl:when test="collection/collCitation">
                        ...
                        <xsl:choose>
                            <xsl:when
                                test="saxon:node-set($collOrProcVolumesToInclude)/refWork[@id=$citation/@refToBook]">
            ...
            <xsl:if test="dissertation">
                ...
                <xsl:call-template name="OutputLabel">
                    ...
                    <xsl:with-param name="pLabel">
                        <xsl:choose>
                            <xsl:when
                                test="string-length(normalize-space(dissertation/@labelDissertation)) &gt; 0">
            ...
            <xsl:if test="thesis">
                ...
                <xsl:call-template name="OutputLabel">
                    ...
                    <xsl:with-param name="pLabel">
                        <xsl:choose>
                            <xsl:when
                                test="string-length(normalize-space(thesis/@labelThesis)) &gt; 0">
...
-->
    <xsl:template name="DoSecTitleRunningHeader">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:apply-templates
                    select="secTitle/child::node()[name()!='endnote'] | frontmatter/title/child::node()[name()!='endnote']"
                />
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
...
-->
    ...
    <xsl:template name="GetBestHangingIndentInitialIndent">
        ...
        <xsl:variable name="sValue"
            select="substring($sThisInitialIndent,1,string-length($sThisHangingIndent)-2)"/>
        <xsl:choose>
...
-->
    <xsl:template name="OutputBackMatterItemTitle">
        ...
        <xsl:choose>
            <xsl:when test="$chapters and not(ancestor::chapterInCollection)">
                <fo:block id="{$sId}" font-size="18pt" font-weight="bold" break-before="page"
                    margin-top="176pt" margin-bottom="10.8pt" text-align="center" span="all">
                    <xsl:call-template name="OutputChapTitle">
            ...
            <xsl:otherwise>
                <fo:block id="{$sId}" font-weight="bold" text-align="center"
                    keep-with-next.within-page="always" span="all">
                    <xsl:attribute name="font-size">
                ...
                <fo:inline>
                    <fo:basic-link>
                        ...
                        <xsl:variable name="interlinear"
                            select="key('InterlinearReferenceID',$sRef)"/>
    ...
    <xsl:template name="OutputTOCLine">
        ...
        <fo:block text-align-last="justify">
            ...
            <xsl:if test="$sIndent!='0'">
                <xsl:attribute name="text-indent">-<xsl:value-of select="$sIndent div 2 + 1.5"
                    />em</xsl:attribute>
                <xsl:attribute name="start-indent">
