...
-->
   ...
   -->
    ...
    <xsl:template name="HandleFreeFontFamily">
        <xsl:variable name="sFontFamily" select="normalize-space(key('LanguageID',@lang)/@font-family)"/>
        <xsl:choose>
            <xsl:when test="string-length($sFontFamily) &gt; 0">
        ...
        <tex:group>
            ...
            <xsl:choose>
                <xsl:when test="$layoutInfo">
                    ...
                    <xsl:if test="$layoutInfo/../@beginsparagraph!='yes'">
                        <tex:cmd name="par" nl2="1"/>
                    </xsl:if>
                    <xsl:call-template name="DoSpaceAfter">
                        <xsl:with-param name="layoutInfo" select="$layoutInfo"/>
    ...
    <xsl:template name="SetFonts">
        ...
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$frontMatterLayoutInfo/titleLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        ...
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$frontMatterLayoutInfo/authorLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$frontMatterLayoutInfo/affiliationLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="DefineAFontFamily">
        ...
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section1Layout/sectionTitleLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section2Layout/sectionTitleLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
                <xsl:call-template name="GetStylesheetFontFamily">
                    <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section3Layout/sectionTitleLayout"/>
                </xsl:call-template>
            </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
            <xsl:call-template name="GetStylesheetFontFamily">
            <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section4Layout/sectionTitleLayout"/>
            </xsl:call-template>
            </xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
            <xsl:call-template name="GetStylesheetFontFamily">
            <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section5Layout/sectionTitleLayout"/>
            </xsl:call-template>
            </xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="DefineAFontFamily">
            ...
            <xsl:with-param name="sBaseFontName">
            <xsl:call-template name="GetStylesheetFontFamily">
            <xsl:with-param name="layoutInfo" select="$bodyLayoutInfo/section6Layout/sectionTitleLayout"/>
            </xsl:call-template>
            </xsl:with-param>
            </xsl:call-template>
        -->
