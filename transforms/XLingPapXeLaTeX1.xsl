...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/lingPaper">
        <tex:TeXML>
            <xsl:comment> generated by XLingPapXeLaTeX1.xsl Version <xsl:value-of select="$sVersion"
                />&#x20;</xsl:comment>
            ...
            <xsl:when test="$chapters">
                ...
                <xsl:choose>
                    <xsl:when test="ancestor::chapterInCollection">
                        <xsl:apply-templates
                            select="author | affiliation | emailAddress | presentedAt | date | version | ../publishingInfo/publishingBlurb"/>
                        <xsl:apply-templates
                            select="contents | acknowledgements | abstract | preface"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:apply-templates
                        ...
                        <xsl:apply-templates
                            select="contents | acknowledgements | abstract | preface" mode="book"/>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:when>
            <xsl:otherwise>
                                    ...
                                    <tex:parm>
                                        <tex:cmd name="textbf">
                                            <tex:parm>
                                                ...
                                                <xsl:if
                                                  test="string-length($contentForThisElement) &gt; 0">
                                                  <tex:spec cat="esc"/>
                                                  <tex:spec cat="esc"/>
                                                </xsl:if>
                                            </tex:parm>
    ...
    <xsl:template match="abstract | acknowledgements | preface" mode="book">
        ...
        <xsl:if test="not(ancestor::chapterInCollection)">
            <xsl:choose>
                ...
                <xsl:when
                    test="name()='abstract' and not(preceding-sibling::contents) and not(preceding-sibling::acknowledgements)">
                    <xsl:call-template name="SetBookNonTitlePageStyle"/>
                </xsl:when>
                <xsl:when
                    test="name()='preface' and not(preceding-sibling::contents) and not(preceding-sibling::acknowledgements) and not(preceding-sibling::preface)">
                    <xsl:call-template name="SetBookNonTitlePageStyle"/>
                </xsl:when>
            </xsl:choose>
        </xsl:if>
                                        ...
                                        <tex:cmd name="raisebox">
                                            ...
                                            <tex:parm>
                                                <tex:cmd name="pdfbookmark" nl2="0">
                                                  ...
                                                  <tex:parm>
                                                  <xsl:call-template
                                                  name="OutputSectionNumberAndTitle">
                                                  <xsl:with-param name="bIsBookmark" select="'Y'"/>
                                                  </xsl:call-template>
                                                  </tex:parm>
                                                  <tex:parm>
                                                  <xsl:value-of
                                                  select="translate(@id,$sIDcharsToMap, $sIDcharsMapped)"
                                                  />
                                                  </tex:parm>
                                                </tex:cmd>
                                            </tex:parm>
        ...
        <xsl:if test="not(ancestor::chapterInCollection)">
            ...
            <xsl:variable name="bFirstChapterInBook">
                <xsl:choose>
                    ...
                    <xsl:when
                        test="name()='chapter' and not(preceding-sibling::chapter) and not($parts)"
                        >Y</xsl:when>
                    <xsl:when
                        test="name()='chapterInCollection' and not(preceding-sibling::chapterInCollection) and not($parts)"
                        >Y</xsl:when>
                    <xsl:when
                        test="name()='chapter' and not(preceding-sibling::chapter) and parent::part and not(parent::part[preceding-sibling::part]) and not($chapterBeforePart)"
                        >Y</xsl:when>
                    <xsl:when
                            ...
                            <tex:parm>
                                <tex:cmd name="LARGE">
                                    <tex:parm>
                                        ...
                                        <xsl:variable name="contentForThisElement">
                                            <xsl:apply-templates
                                                select="secTitle | frontMatter/title"/>
                                        </xsl:variable>
                                        <xsl:if
                                            test="string-length($contentForThisElement) &gt; 0">
                                            <tex:spec cat="esc"/>
        ...
        <xsl:choose>
            <xsl:when test="$chapters">
                ...
                <xsl:number level="any"
                    count="figure[not(ancestor::endnote or ancestor::framedUnit)]"
                    from="chapter | appendix | chapterBeforePart | chapterInCollection" format="1"/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:number level="any"
                    count="figure[not(ancestor::endnote or ancestor::framedUnit)]" format="1"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
    <!--  
    ...
    <xsl:template mode="tablenumbered" match="*" priority="10">
        <xsl:choose>
            <xsl:when test="$chapters">
                ...
                <xsl:text>.</xsl:text>
                <xsl:number level="any"
                    count="tablenumbered[not(ancestor::endnote or ancestor::framedUnit)]"
                    from="chapter | appendix | chapterBeforePart | chapterInCollection" format="1"/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:number level="any"
...
-->
   ...
   -->
    ...
    <xsl:template name="DefineLangaugeAndTypeFonts">
        <xsl:for-each
            select="//language | //type[string-length(normalize-space(@font-family)) &gt; 0] | //keyTerm[string-length(normalize-space(@font-family)) &gt; 0]">
   ...
   -->
    ...
    <xsl:template name="DoContents">
        ...
        <xsl:if
            test="//references[not(ancestor::chapterInCollection)] and //citation[not(ancestor::chapterInCollection/backMatter/references)]">
            <xsl:call-template name="OutputTOCLine">
    ...
    <xsl:template name="DoContentsInChapterInCollection">
        ...
        <xsl:for-each select="ancestor::chapterInCollection">
            <xsl:if
                test="frontMatter/abstract  or frontMatter/acknowledgements or frontMatter/preface">
    ...
    <xsl:template name="DoReferences">
        ...
        <xsl:variable name="authors"
            select="//refAuthor[refWork/@id=//citation[not(ancestor::comment)]/@ref]"/>
        <xsl:if test="$authors">
            <xsl:if test="@showinlandscapemode='yes'">
                <tex:cmd name="landscape" gr="0" nl2="1"/>
            </xsl:if>
                                ...
                                <tex:cmd name="pdfbookmark" nl2="0">
                                    <tex:opt>
                                        <xsl:variable name="iLevel"
                                            select="substring-after(name(),'section')"/>
                                        <xsl:choose>
                                            <xsl:when
                                                test="name()='section1' and ancestor::appendix and ancestor::chapterInCollection"
                                                >3</xsl:when>
                                            <xsl:when
                                                test="name()='section2' and ancestor::appendix and ancestor::section1"
                                                >3</xsl:when>
                                            <xsl:when
                                                test="ancestor::chapter or ancestor::chapterBeforePart or ancestor::chapterInCollection">
                                                <xsl:value-of select="$iLevel + 1"/>
                                            </xsl:when>
                                            <xsl:when
                                                test="name()='section1' and ancestor::appendix"
                                                >2</xsl:when>
                                            <xsl:otherwise>
    ...
    <xsl:template name="OutputSectionNumberAndTitle">
        ...
        <xsl:choose>
            <xsl:when test="$bIsBookmark='Y'">
                <xsl:apply-templates
                    select="secTitle/text() | secTitle/*[name()!='comment'] | frontMatter/title/text() | frontMatter/title/*[name()!='comment']"
                    mode="bookmarks"/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:apply-templates select="secTitle | frontMatter/title"/>
...
-->
    ...
    <xsl:template name="OutputChapterInCollectionBackMatterContents">
        <xsl:param name="nLevel"/>
        <xsl:variable name="sChapterInCollectionID"
            select="ancestor-or-self::chapterInCollection/@id"/>
...
-->
    ...
    <xsl:template name="OutputTOCLine">
        ...
        <tex:cmd name="XLingPaperdottedtocline" nl2="1">
            ...
            <tex:parm>
                <xsl:variable name="sPage"
                    select="document($sTableOfContentsFile)/toc/tocline[@ref=translate($sLink,$sIDcharsToMap,$sIDcharsMapped)]/@page"/>
                <xsl:choose>
                    <xsl:when test="$sPage">
                        <xsl:value-of select="$sPage"/>
                    </xsl:when>
